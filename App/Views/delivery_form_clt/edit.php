<section class="content-header">
    <span class="content-title"><i class="fa fa-edit"></i> إضافة وتعديل تسليم منتجات</span>
</section>
    ...
    <form method="post" name="form-delivery_form-add" id="form-delivery_form-add" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 form-group text-center">
                <hr>
                <button type="submit" id="btn-save-delivery_form" class="btn btn-primary">حفظ</button>
            </div>
        </div>
    </form>
</section>
